" Modified version of 'bubblegum' theme, reversed color of N2 and N3
...
let s:gui_light_gray = '#6c6c6c'
let s:cterm_light_gray = 242
...
let s:N2 = [s:gui_blue, s:gui_med_gray_lo, s:cterm_blue, s:cterm_med_gray_lo]
let s:N3 = [s:gui_light_gray, s:gui_med_gray_hi, s:cterm_light_gray, s:cterm_med_gray_hi]
...
let s:I2 = [s:gui_green, s:gui_med_gray_lo, s:cterm_green, s:cterm_med_gray_lo]
let g:airline#themes#custom#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:N3)
...
let s:V2 = [s:gui_pink, s:gui_med_gray_lo, s:cterm_pink, s:cterm_med_gray_lo]
let g:airline#themes#custom#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:N3)
...
let g:airline#themes#custom#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
      ...
      \ [ s:gui_dark_gray, s:gui_blue, s:cterm_dark_gray, s:cterm_blue, 'bold' ] )
